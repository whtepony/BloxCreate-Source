            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 text-center">
                        ...
                        <br>
                        <a href="{{ route('users.profile', ['id' => $user->id, 'username' => $user->username]) }}" class="btn btn-fluid btn-primary" target="_blank">View</a>
                    ...
                    @if (Auth::user()->power >= 4)
                        <div class="col-md-12 col-lg-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <h3 class="text-success font-weight-bold">Verification</h3>
                                    <form action="{{ route('admin.users.grant') }}" method="POST">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="user_id" value="{{ $user->id }}">
                                        <input type="hidden" name="type" value="verify">
                                        <button class="btn btn-block {{ $user->verified() ? 'btn-danger' : 'btn-success' }}" type="submit">
